...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname Assignment3-b-1) (read-case-sensitive #t) (teachpacks ((lib "universe.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "abstraction.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "universe.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "abstraction.rkt" "teachpack" "2htdp")) #f)))
(define KLEINKIND 120)
(define KIND 140)

; Besucher ist ein Number und fällt in eines der Intervalle
; - von 0 bis KLEINKIND
; - größer als KLEINKIND und <= KIND
; - größer als KIND
