...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname Assignment03a) (read-case-sensitive #t) (teachpacks ((lib "universe.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "abstraction.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "universe.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "abstraction.rkt" "teachpack" "2htdp")) #f)))
...
(check-within (rotationProErdtage "merkur" 1) 58.85 0.01)
...
(define (rotationProErdtage planet d)
  (cond
    [(string=? planet "merkur") (* (/ 84456 1436) d)]
    [(string=? planet "venus") (* (/ 349947 1436) d)]
    [(string=? planet "erde") (* (/ 1436 1436) d)]
    [(string=? planet "mars") (* (/ 1537 1436) d)]))
