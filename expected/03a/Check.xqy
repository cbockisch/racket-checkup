...
aa:assertPresent("Die Funktion rotationProErdtage mit zwei Parameter ist nicht definiert.",
  aa:funDecl("rotationProErdtage", 2, true(), /drracket)),

aa:assertPresent("Es sind keine Tests für die Function rotationProErdtage definiert.",
  aa:precedingTests(aa:funDecl("rotationProErdtage", 2, true(), /drracket))),

aa:assertPresent("Es ist kein Kommentar für die Funktion rotationProErdtage angegeben",
  aa:functionComment(aa:funDecl("rotationProErdtage", 2, true(), /drracket))),

aa:assertTrue("Für die Funktion rotationProErdtage ist die Signatur nicht oder nicht korrekt dokumentiert.",
  aa:funDocMatchesSignature(aa:funDecl("rotationProErdtage", 2, true(), /drracket),
("InnererPlanet", "Number"), "Number")),

aa:assertTrue("Die Dokumentation für die Funktion rotationProErdtage enthält keine Beschreibung für alle parameter.",
  aa:funDocContainsParams(aa:funDecl("rotationProErdtage", 2, true(), /drracket))),
...
aa:assertPresent("Der Datentyp InnererPlanet ist nicht korrekt als Kommentar definiert. Zählen Sie als Strichliste alle Fälle auf, ein Fall pro Zeile.", aa:enumTypeComment(/drracket, "InnererPlanet", ('"merkur"', '"venus"', '"erde"', '"mars"'))),

aa:assertTrue("Die Tests decken nicht alle Fälle ab.", aa:enumTypeTests(aa:funDecl("rotationProErdtage", 2, true(), /drracket), ('"merkur"', '"venus"', '"erde"', '"mars"')))
