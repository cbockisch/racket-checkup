...
aa:assertPresent("Die Funktion rome mit einem Parameter ist nicht definiert.",
  aa:funDecl("rome", 1, true(), /drracket)),

aa:assertPresent("Es sind keine Tests für die Function rome definiert.",
  aa:precedingTests(aa:funDecl("rome", 1, true(), /drracket))),

aa:assertPresent("Es ist kein Kommentar für die Funktion rome angegeben",
  aa:functionComment(aa:funDecl("rome", 1, true(), /drracket))),

aa:assertTrue("Für die Funktion rome ist die Signatur nicht oder nicht korrekt dokumnentiert.",
  aa:funDocMatchesSignature(aa:funDecl("rome", 1, true(), /drracket),
("Number"), "String")),

aa:assertTrue("Die Dokumentation für die Funktion rome enthält keine Beschreibung für alle parameter.",
  aa:funDocContainsParams(aa:funDecl("rome", 1, true(), /drracket))),
